...
def load_and_analyze_data():
    ...
    # ----------------------------------------------------------------------
    # GENES DE INTERESSE - ADAPTADO PARA CCL11, CCL24, CCL26
    GENES_OF_INTEREST = ['CCL11', 'CCL24', 'CCL26']
    ...
    # CORES PERSONALIZADAS PARA OS GENES
    # Dark2 usa: Verde-azulado, Laranja, Marrom/Cinza...
    # Definindo as cores manualmente:
    # 1. CCL11: Verde-azulado do Dark2 (padrão) -> '#1b9e77'
    # 2. CCL24: Laranja do Dark2 (padrão) -> '#d95f02'
    # 3. CCL26: Verde Escuro (Cor solicitada) -> '#006400'
    GENE_COLORS = ['#1b9e77', '#d95f02', '#006400']
    # ----------------------------------------------------------------------
    ...
    # ALTERAÇÃO DE COR: Usando a lista de cores personalizadas
    ...
    for i, gene in enumerate(GENES_OF_INTEREST):
        ...
        for bar, absolute_count_val, percentage_val in zip(bars, absolute_count, heights):
            ...
            # Embora seja mais complexo, mantemos a lógica original para garantir que as alterações sejam mínimas.
            ...
            if bar.get_height() > 3: 
                ...
                # Simples verificação de luminância para contraste.
                # Para verde escuro, o branco é geralmente melhor.
                text_color = 'white' if current_color == '#006400' else 'black'
    ...
    ax.set_title(f'Frequência de Expressão Individual dos Genes ({genes_str}) por Subtipo PAM50 (Excluído: Normal)', fontsize=14, pad=20)
    ...
    print("\nAnálise concluída. O gráfico de barras empilhadas foi gerado e exibido.")
